<template>
  <div class="nav">
	...
	<nav>
		...
		<ul>
			<router-link to="/guide" tag="li">指南</router-link>
			<router-link to="/component" tag="li">组件</router-link>
			<router-link to="/c" tag="li">主题</router-link>
			<router-link to="/d" tag="li">资源</router-link>
		</ul>
		<span class="line">|</span>
		<el-dropdown trigger="click">
			<span class="el-dropdown-link">
				2.12.0<i class="el-icon-arrow-down el-icon--right"></i>
			</span>
			<el-dropdown-menu slot="dropdown">
				<el-dropdown-item @click.native="versionClick('2.8.0')">2.8.0</el-dropdown-item>
				<el-dropdown-item @click.native="versionClick('2.9.0')">2.9.0</el-dropdown-item>
				<el-dropdown-item @click.native="versionClick('2.10.0')">2.10.0</el-dropdown-item>
				<el-dropdown-item @click.native="versionClick('2.11.0')">2.11.0</el-dropdown-item>
				<el-dropdown-item @click.native="versionClick('2.12.0')">2.12.0</el-dropdown-item>
			</el-dropdown-menu>
		</el-dropdown>
		<el-dropdown trigger="click">
			<span class="el-dropdown-link">
			...
			<el-dropdown-menu slot="dropdown">
				<el-dropdown-item @click.native="langClick('中文')">中文</el-dropdown-item>
				<el-dropdown-item @click.native="langClick('English')">English</el-dropdown-item>
				<el-dropdown-item @click.native="langClick('日本语')">日本语</el-dropdown-item>
			</el-dropdown-menu>
		</el-dropdown>
	</nav>
  </div>
